...
export const skillsInstall = (source: string, agentIds: string[]) =>
  invoke<SkillMeta>("skills_install", { source, agentIds });
...
export const skillsImportScan = () => invoke<UnmanagedSkill[]>("skills_import_scan");
